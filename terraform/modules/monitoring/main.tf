# ProjectHub - Monitoring Module
# CloudWatch Alarms, Dashboards, SNS Topics
...
resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  ...
  statistic           = "Average"
  threshold           = 85
  alarm_description   = "CPU utilization exceeds 85%"
...
resource "aws_cloudwatch_metric_alarm" "alb_5xx" {
  ...
  statistic           = "Sum"
  threshold           = 5
  alarm_description   = "ALB 5xx errors exceed 5 per 5 minutes"
  alarm_actions       = [aws_sns_topic.alerts.arn]
}
